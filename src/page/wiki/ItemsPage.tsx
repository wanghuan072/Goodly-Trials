  ...
  return (
    <main>
      <section className={styles.hero}>
        <Image className={styles.heroImage} src="/images/game/screenshot-6.webp" alt="Goodly Trials advanced training screen explaining frontline targeting" fill preload sizes="100vw" />
